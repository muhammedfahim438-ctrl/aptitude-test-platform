...
class Command(BaseCommand):
    help = 'Seeds test Questions + AnswerKey + StudentSubmissions for today.'
    ...
    def handle(self, *args, **options):
        ...
        if not students.exists():
            self.stdout.write(self.style.WARNING("No students found. Create student accounts first."))
            return
