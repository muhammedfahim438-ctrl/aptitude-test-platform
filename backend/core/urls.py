...
from pipeline.views import (
    ...
    compute_monthly_leaderboard_view,
    flush_monthly_leaderboard_view,
    aggregate_scores_view,
    cleanup_day_view,
    DashboardStatsView,
    AdminRankingsView,
    AdminReportsView,
...
urlpatterns = [
    ...
    path('api/internal/flush-monthly-leaderboard/', flush_monthly_leaderboard_view, name='flush-monthly-leaderboard'),
    path('api/internal/compute-monthly-leaderboard/', compute_monthly_leaderboard_view, name='compute-monthly-leaderboard'),
    path('api/internal/aggregate-scores/', aggregate_scores_view, name='aggregate-scores'),
